...
export class Backend implements backendInterface {
    ...
    async createTask(arg0: string, arg1: string): Promise<Task> {
        if (this.processError) {
            try {
    ...
    async editTask(arg0: bigint, arg1: Task): Promise<Task> {
        if (this.processError) {
            try {
                const result = await this.actor.editTask(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleTask(arg0: bigint, arg1: boolean): Promise<Task> {
        if (this.processError) {
            try {
